...
if not exist "%RAW%\MEN_SEDES_EDUCATIVAS_PREESCOLAR_BÁSICA_Y_MEDIA_20260605.csv" (
  ...
  echo %RAW%\MEN_SEDES_EDUCATIVAS_PREESCOLAR_BÁSICA_Y_MEDIA_20260605.csv
  echo.
  echo Copie el CSV descargado de Datos Abiertos/MEN en la carpeta raw con ese nombre exacto.
  pause
  exit /b 1
)
