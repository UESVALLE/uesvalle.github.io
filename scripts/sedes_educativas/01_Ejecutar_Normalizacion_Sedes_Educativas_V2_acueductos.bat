...
echo.
echo =============================================================================
echo  PROCESO V2 FINALIZADO CORRECTAMENTE
echo =============================================================================
echo.
echo Revise la nueva capa de acueductos en:
echo %ROOT%\data\sedes_educativas\current\maestro_acueductos_mapa.csv
echo.
